    ...
    <MainLayout fullWidth>
      ...
      <div className="max-w-5xl mx-auto px-4 pb-16">
        <div className="text-center pt-8 pb-10">
          <h1 className="text-2xl sm:text-3xl font-black mb-3" style={{ color: '#E8F4FF' }}>تماس با ما</h1>
          <p style={{ color: '#6B8FAD' }}>سوالی دارید؟ خوشحال می‌شویم کمکتان کنیم</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
          <a href="mailto:support@nobatiic.ir" className="rounded-2xl p-5 text-center hover:-translate-y-1 transition-all duration-200 group"
            ...
            <h3 className="text-sm font-bold mb-1" style={{ color: '#E8F4FF' }}>ایمیل</h3>
          ...
          <a href="tel:02144000000" className="rounded-2xl p-5 text-center hover:-translate-y-1 transition-all duration-200 group"
            ...
            <h3 className="text-sm font-bold mb-1" style={{ color: '#E8F4FF' }}>تلفن</h3>
          ...
          <div className="rounded-2xl p-5 text-center hover:-translate-y-1 transition-all duration-200 group"
            ...
            <h3 className="text-sm font-bold mb-1" style={{ color: '#E8F4FF' }}>آدرس</h3>
            <p className="text-xs" style={{ color: '#6B8FAD' }}>تهران، ایران</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* Form */}
          <div className="rounded-2xl p-6" style={{ background: '#1C2A3E', border: '1px solid rgba(0,212,200,0.07)' }}>
            <h2 className="text-sm font-bold mb-5" style={{ color: '#E8F4FF' }}>فرم تماس</h2>
            ...
            {submitted ? (
              <div className="text-center py-8 space-y-3">
                ...
                <p className="text-sm font-bold" style={{ color: '#E8F4FF' }}>پیام شما ارسال شد!</p>
                <p className="text-xs" style={{ color: '#6B8FAD' }}>در اولین فرصت با شما تماس خواهیم گرفت.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="text-xs font-bold mb-2 block" style={{ color: '#6B8FAD' }}>نام</label>
                  <input type="text" name="name" value={form.name} onChange={handleChange} required
                         placeholder="نام شما" className={inputCls} style={inputStyle} />
                </div>
                <div>
                  <label className="text-xs font-bold mb-2 block" style={{ color: '#6B8FAD' }}>ایمیل</label>
                  <input type="email" name="email" value={form.email} onChange={handleChange} required
                         placeholder="email@example.com" dir="ltr" className={`${inputCls} text-left`} style={inputStyle} />
                </div>
                <div>
                  <label className="text-xs font-bold mb-2 block" style={{ color: '#6B8FAD' }}>موضوع</label>
                ...
                <div>
                  <label className="text-xs font-bold mb-2 block" style={{ color: '#6B8FAD' }}>پیام</label>
          ...
          {/* FAQ */}
          <div>
            <h2 className="text-sm font-bold mb-5" style={{ color: '#E8F4FF' }}>سوالات متداول</h2>
            <div className="space-y-2">
              {FAQS.map((faq, i) => (
                <details key={i} className="rounded-xl overflow-hidden group" style={{ background: '#1C2A3E', border: '1px solid rgba(0,212,200,0.07)' }}>
                  <summary className="flex items-center justify-between p-4 cursor-pointer list-none">
                    <span className="text-sm font-semibold" style={{ color: '#E8F4FF' }}>{faq.q}</span>
                  ...
                  <p className="px-4 pb-4 text-xs leading-6" style={{ color: '#6B8FAD' }}>{faq.a}</p>
                </details>
              ))}
            </div>
          </div>
